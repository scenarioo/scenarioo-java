...
public class ScenarioDocuReader {
	...
	public List<Branch> loadBranches() {
		...
		return ScenarioDocuXMLFileUtil.unmarshalListOfFilesIgnoreInvalid(Branch.class, branchFiles);
	}
	...
	public List<ObjectFromDirectory<Build>> loadBuilds(final String branchName) {
		...
		return ScenarioDocuXMLFileUtil.unmarshalListOfFilesWithDirNamesIgnoreInvalid(buildFiles, Build.class);
	}
